...
export default function Home() {
  return (
    <main className="w-full relative bg-themeGreen text-white p-4">    
      <Fade className="flex flex-col-reverse md:flex-row-reverse my-16">
        <div className='flex-1 px-2 py-4 flex flex-col items-center justify-center'>
          <h2 className='text-2xl text-center py-4'>Helping players of all ages, skill sets, and backgrounds find success and fulfilment in the game of soccer.</h2>      
        </div>
      ...
      <Fade>        
        <div className="my-16">    
          ...
          <div className="flex w-full justify-center my-4">    
            <Link href="/coaching" className='py-2 px-4 bg-white text-themeGreen border-2 border-white font-bold rounded-xl hover:opacity-70 '>Learn More</Link>
          </div>
          <div className='w-full max-w-[1800px] mx-auto'>
