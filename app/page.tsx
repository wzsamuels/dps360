  ...
  return (
    <main className="w-full relative">
      <div className='bg-themeGreen text-center flex flex-col items-center justify-center font-bold text-white  box pb-64'>
        <h1 className='text-5xl py-8 px-4 '>Differentials Planet Soccer 360</h1>
        <p className='text-3xl max-w-xl w-full py-4'>Helping players of all ages, skill sets, and backgrounds find success and fulfilment in the game of soccer. </p>     
      </div>
